...
//   socket.on('sendMessageToAdmin', async ({ senderId, message, productInfo }) => {
...
//       // Notify admin team about the new message
//       io.emit('receiveMessageFromUser', newMessage);
//       console.log(`Message from user ${senderId} sent to admin team`);
